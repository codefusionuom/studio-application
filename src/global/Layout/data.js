...
export const stockManagerList = [{
    name: "Dashboard",path:"/stockManager", icon:<DashboardOutlinedIcon/>
}, {
    name: "GRN",path:"/stockManager/grn", icon: <Inventory2OutlinedIcon/>
}, {
    name: "Suppliers",path:"/stockManager/supplier", icon:<PersonOutlineOutlinedIcon/>
},
{
    name: "Payment",path:"/stockManager/payment", icon:<PaymentsOutlinedIcon />
},

{
    name: "Returned Stock",path:"/stockManager/returnedStock" , icon: <AssignmentReturnOutlinedIcon/>
  
},
{
    name: "Stock Item",path:"/stockManager/stockItem" , icon: <InventoryOutlinedIcon/>
},
{
