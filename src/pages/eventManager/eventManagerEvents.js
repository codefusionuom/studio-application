          ...
          <Popover placement="bottom">
            ...
            <PopoverContent>
              <DayPicker
                ...
                selected={date}
                // onSelect={setDate}
                onSelect={(selectedDate) => {            //tttttttttttttttttttttt
              ...
              : (
                eventList.map((oneEvent, index) => {
                  ...
                  return (
                    ...
                    <tr key={oneEvent.eventId}
                     onClick={ ()=>navigate("/eventManager/eventDetails" , {state :{eventId:oneEvent.eventId}})} >
                      <td className={classes}>
                        <div className="flex items-center gap-3">
                          <div className="flex flex-col">
                            ...
                            >
                              {oneEvent.customer.firstname + " " + oneEvent.customer.lastname}
                            </Typography>
                          </div>
                        </div>
                      </td>
