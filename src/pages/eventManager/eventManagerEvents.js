...
//     try {
//       const res = await axiosInstance.get("/eventManager/all-events");
...
//   const getSelectedDayEvents = async (selectedDate) => {
//     try {
//       const res = await axiosInstance.post("/eventManager/selectedDayEvents", {
//         date: selectedDate,
//       });
//       setEventList(res.data.todayEvents);
//     } catch (error) {
...
//                       strokeWidth="1.5"
//                       stroke="currentColor"
//                       className="w-6 h-6 mr-2 text-blue-gray"
//                     >
//                       <path
//                         strokeLinecap="round"
//                         strokeLinejoin="round"
...
//                   </td>
//                 </tr>
//                 <tr className="flex justify-between border-y border-blue-gray-100 bg-blue-gray-50 p-4">
//                   {TABLE_HEAD.map((head) => (
//                     <th
//                       key={head}
...
//                       return (
//                         <tr key={_id} className="flex justify-between">
//                           <td className={classes}>
//                             <Typography
//                               variant="small"
//                               color="blue-gray"
...
//                         className="font-normal"
//                       >
//                         {date ? "No events for the selected date." : <Spinner />}
//                       </Typography>
//                     </td>
//                   </tr>
//                 )}
