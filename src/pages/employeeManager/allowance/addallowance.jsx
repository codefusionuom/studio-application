            ...
            <form onSubmit={Submit}>
              ...
              <div className=" flex flex-row justify-between ">
                ...
                <Typography className="mb-2" variant="h6">
                  ...
                  <Select label="Select Type"  onChange={(e) => { setType(e) }} error={errorName ? "true" : null}>
              ...
              <div className=" flex flex-row justify-between ">
                ...
                <Typography className="mb-2" variant="h6">
                  ...
                  <Select label={'Select ' + type} onChange={item => { setId(item) }} error={errorName ? "true" : null} disabled={type !== "Allowance" && type !== "Deduction" ? "true" : null}>
